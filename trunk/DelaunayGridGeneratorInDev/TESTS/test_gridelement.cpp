...
{
    int _n[] = {0,1,2};
    QList<WrappedNode2D> _nodesList = {
        MathUtils::Node2D(0,0), MathUtils::Node2D(1,0), MathUtils::Node2D(0,1)};
    ...
    QList<WrappedNode3D> _nodesList2 = {
        MathUtils::Node3D(1,0,0), MathUtils::Node3D(0,1,0), MathUtils::Node3D(0,0,0)};
